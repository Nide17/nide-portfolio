                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                {project.github_backend ? (
                                    <Link
                                        ...
                                        className="flex items-center justify-between p-6 bg-gray-900 text-white rounded-xl hover:bg-gray-800 transition-all duration-300 group"
                                    >
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                <div className="font-semibold text-white hover:text-gray-200">Backend Repository</div>
                                ...
                                {project.github_frontend ? (
                                    ...
                                    >
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                <div className="font-semibold text-white hover:text-gray-200">Frontend Repository</div>
                                                <div className="text-sm text-gray-400">View source code</div>
                                            </div>
                                        </div>
                                        <svg className="w-5 h-5 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
