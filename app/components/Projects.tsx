                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {projects.map((project) => (
                            <Link
                                ...
                                className="group block bg-white rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 overflow-hidden border border-gray-100 hover:border-blue-200 transform hover:-translate-y-2"
                            >
                                {project.image && (
                                    ...
                                    <div className="p-2 mt-4">
                                            <div className="flex gap-3 justify-center items-center">
                                                <div className="flex gap-3">
                                                    {project.github && (
                                                        <Link href={project.github} target="_blank" rel="noopener noreferrer" className="flex items-center gap-1 text-xs text-gray-500 hover:text-gray-900 font-medium transition-colors p-1 rounded hover:bg-gray-100 truncate max-w-24">
                                                            ...
                                                            <span className="truncate max-w-20">GitHub</span>
                                                        </Link>
                                                    )}
                                                    {project.live_at && (
                                                        <Link href={project.live_at} target="_blank" rel="noopener noreferrer" className="flex items-center gap-1 text-xs text-emerald-600 hover:text-emerald-700 font-medium transition-colors p-1 rounded hover:bg-emerald-50 truncate max-w-24">
