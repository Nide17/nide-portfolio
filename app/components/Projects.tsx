                                ...
                                <div className="p-8">
                                    ...
                                    {project.technologies && project.technologies.length > 0 && (
                                        <div className="flex flex-wrap gap-2 mb-6">
                                            {project.technologies.slice(0, 4).map((tech: string, index: number) => (
                                                <span
                                                    key={index}
                                                    className="px-3 py-1 bg-linear-to-r from-blue-100 to-sky-100 text-blue-800 text-sm font-medium rounded-full shadow-sm border border-blue-200"
                                                >
                                                    {tech}
                                                </span>
                                            ))}
                                    ...
                                    <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                                        <div className="flex gap-4">
                                            {project.github && (
                                                <div className="flex items-center gap-2 text-gray-600 hover:text-black font-medium transition-colors">
                                            ...
                                            {project.live_at && (
                                                <div className="flex items-center gap-2 text-green-600 hover:text-green-700 font-medium transition-colors">
