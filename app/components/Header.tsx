...
export default function Header() {
    ...
    const desktopNavClass = `font-bold bg-linear-to-r from-blue-600 to-sky-400 bg-clip-text text-transparent hover:from-blue-700 hover:to-sky-500 transition-all duration-300 font-['Poppins',system-ui,sans-serif] ${isScrolled ? 'text-lg' : 'text-xl'}`
    const mobileNavClass = "rounded-2xl border border-transparent bg-sky-50 px-4 py-3 text-left text-sm font-semibold font-['Poppins',system-ui,sans-serif] tracking-wide transition-all hover:border-sky-100 hover:bg-sky-100 sm:text-base"
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className={`flex justify-between transition-all duration-300 ${isScrolled ? 'h-20' : 'h-24'
                    ...
                    <div className="flex items-center">
                        <Link href="/" className={`font-bold transition-all duration-300 font-['Poppins',system-ui,sans-serif] tracking-wide sm:tracking-wider ${isScrolled ? 'text-lg sm:text-4xl' : 'text-xl sm:text-5xl'
                            }`}>
